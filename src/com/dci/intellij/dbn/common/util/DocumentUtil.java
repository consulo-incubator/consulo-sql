...
public class DocumentUtil
{
	public static void touchDocument(final Editor editor)
	{
		...
		if(file instanceof DBLanguageFile)
		{
			...
			DBLanguageSyntaxHighlighter syntaxHighlighter = connectionHandler == null ? sqlLikeLanguage
					.getFirstVersion().getSyntaxHighlighter() : connectionHandler.getLanguageDialect(sqlLikeLanguage)
					.getSyntaxHighlighter();

			EditorHighlighter editorHighlighter = HighlighterFactory.createHighlighter(syntaxHighlighter,
